...
levelCleared = pygame.mixer.Sound("levelCleared.wav")
levelCleared.set_volume(0.5)

deathNoise = pygame.mixer.Sound("deathNoise.mp3")
deathNoise.set_volume(0.7)

buttonPress = pygame.mixer.Sound("buttonPress.mp3")
buttonPress.set_volume(0.1)
...
class Player:
    ...
    def move(self, pressed_keys):
        ...
        if pressed_keys[pygame.K_UP] and self.on_ground:
            ...
            self.on_ground = False
        if pressed_keys[pygame.K_w] and self.on_ground:
            jump.play()
            self.y_velocity = -JUMP_FORCE
            self.on_ground = False
...
def add_obstacle(level):
    if level == 2:
        ...
        SPIKES.append(pygame.Rect(270, 480, 40, 40))  # add spike to second platform
    elif level == 7:
        SPIKES.append(pygame.Rect(1120, 440, 40, 40))  # add spike above door
    elif level == 8:
        SPIKES.append(pygame.Rect(1220, 440, 40, 40))  # add second spike above door
    elif level == 9:
        PLATFORMS.append(pygame.Rect(1100, 460, 150, 20))  # add platform
        PLATFORMS.append(pygame.Rect(1060, 650, 150, 20))  # add platform
    elif level == 10:
        SPIKES.append(pygame.Rect(650, 380, 40, 40))  # add spike to third platform
        SPIKES.append(pygame.Rect(530, 380, 40, 40))  # add spike to third platform
